...
\resumeItemListStart
  \resumeItem{Project: Satellite Imagery AI Automatic Identification System}{
    \resumeNestedListStart
      ...
      \item AI Serving \& Deployment (Kubeflow Ecosystem): Served models as \textbf{KServe} InferenceServices on Kubernetes with an NVIDIA Triton runtime, fronted by a FastAPI/gRPC gateway; versioned and promoted checkpoints through the \textbf{Kubeflow Model Registry}, and orchestrated training-to-deployment runs as \textbf{Kubeflow Pipelines}. Applied \textbf{Distributed Data Parallel (DDP)} across multiple GPUs to ensure efficient execution of large-scale inference tasks.
